...
extern struct tensor *devito_stencil_kernel_adapter(struct tensor *tensor, struct star_stencil *stencil, int iterations, float a, float dt, float h_x, float h_y, float h_z, float *devito_timer);
